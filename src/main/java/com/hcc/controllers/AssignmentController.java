...
public class AssignmentController {
    ...
    public ResponseEntity<List<AssignmentResponseDto>> getAssignmentsByUser(@PageableDefault(size = 5,
                                                                                direction = Sort.Direction.ASC,
                                                                                sort = "id") Pageable pageable,
                                                                            @AuthenticationPrincipal User user) {
        Page<Assignment> assignmentsPage = assignmentRepository.findByUser(
                user, PageRequest.of(
        ...
        List<AssignmentResponseDto> assignmentDTO = assignmentsPage.getContent().stream()
    ...
    public ResponseEntity<?> createAssignment(@RequestBody Assignment assignment,
        ...
        AssignmentResponseDto assignmentDto = new AssignmentResponseDto(assignment);
